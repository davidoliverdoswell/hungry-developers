...
let developers : [Developer] = [firstDeveloper, secondDeveloper, thirdDeveloper, fourthDeveloper, fifthDeveloper]

DispatchQueue.concurrentPerform(iterations: 5) {
    developers[$0].run()
}

func developersEatAndThink() {
    
    if firstDeveloper.leftSpoon == nil {
        fifthDeveloper.rightSpoon != nil
    }
}
